...
<body data-ng-controller="AppendController" class="container">
	...
	<!-- 			</div> -->
				<label for="deptno">Deptno</label>
				<select id="deptno" name="deptno" class="form-control" data-ng-model="emp.deptno">
					<option value="">--선택하세요--</option>
					<option data-ng-repeat="dept in depts" value="{{dept.deptno}}">{{dept.deptno}} / {{dept.dname}} / {{dept.loc}}</option>				
				</select>
			</div>
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<textarea rows="5" style="width:100%;">{{format()}}</textarea>
