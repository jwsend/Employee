...
<body data-ng-controller="AppendController" class="container">
	...
	<form name="deptForm" method="post" novalidate="novalidate" data-ng-submit="submit()">
		...
		<div class="form-group">
			...
			<input id="deptno" type="number" name="deptno" class="form-control" data-ng-model="dept.deptno" data-ng-min="0" data-ng-max="99" required="required" />
		...
		<div class="form-group">
			...
			<input type="submit" class="btn btn-primary" data-ng-disabled="deptForm.$invalid" value="부서추가" />&nbsp;&nbsp;<input type="reset" class="btn btn-primary" value ="초기화" />
