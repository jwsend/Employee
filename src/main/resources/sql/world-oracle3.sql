...
insert into city values (20,'xs-Hertogenbosch','NLD','Noord-Brabant',129170);
...
insert into city values (33,'Willemstad','ANT','Curaxao',2345);
...
insert into city values (40,'Sxtif','DZA','Sxtif',179055);
insert into city values (41,'Sidi Bel Abbxs','DZA','Sidi Bel Abbxs',153106);
...
insert into city values (61,'South Hill','AIA','x',961);
insert into city values (62,'The Valley','AIA','x',595);
insert into city values (63,'Saint Johnxs','ATG','St John',24000);
...
insert into city values (71,'Cxrdoba','ARG','Cxrdoba',1157507);
insert into city values (72,'Rosario','ARG','Santa Fx',907718);
...
insert into city values (78,'San Miguel de Tucumxn','ARG','Tucumxn',470809);
insert into city values (79,'Lanxs','ARG','Buenos Aires',469735);
insert into city values (80,'Merlo','ARG','Buenos Aires',463846);
insert into city values (81,'General San Martxn','ARG','Buenos Aires',422542);
insert into city values (82,'Salta','ARG','Salta',367550);
insert into city values (83,'Moreno','ARG','Buenos Aires',356993);
insert into city values (84,'Santa Fx','ARG','Santa Fx',353063);
...
insert into city values (87,'Morxn','ARG','Buenos Aires',349246);
...
insert into city values (92,'Vicente Lxpez','ARG','Buenos Aires',288341);
...
insert into city values (96,'Bahxa Blanca','ARG','Buenos Aires',239810);
insert into city values (97,'Esteban Echeverrxa','ARG','Buenos Aires',235760);
insert into city values (98,'Resistencia','ARG','Chaco',229212);
insert into city values (99,'Josx C. Paz','ARG','Buenos Aires',221754);
insert into city values (100,'Paranx','ARG','Entre Rios',207041);
insert into city values (101,'Godoy Cruz','ARG','Mendoza',206998);
insert into city values (102,'Posadas','ARG','Misiones',201273);
insert into city values (103,'Guaymallxn','ARG','Mendoza',200595);
...
insert into city values (107,'Neuquxn','ARG','Neuquxn',167296);
insert into city values (108,'Ituzaingx','ARG','Buenos Aires',158197);
...
insert into city values (114,'Rxo Cuarto','ARG','Cxrdoba',134355);
insert into city values (115,'Comodoro Rivadavia','ARG','Chubut',124104);
insert into city values (116,'Mendoza','ARG','Mendoza',123027);
insert into city values (117,'San Nicolxs de los Arroyos','ARG','Buenos Aires',119302);
...
insert into city values (127,'Gjumri','ARM','xirak',211700);
insert into city values (128,'Vanadzor','ARM','Lori',172700);
insert into city values (129,'Oranjestad','ABW','x',29034);
...
insert into city values (145,'Gxncx','AZE','Gxncx',299300);
insert into city values (146,'Sumqayit','AZE','Sumqayit',283000);
insert into city values (147,'Mingxxevir','AZE','Mingxxevir',93900);
...
insert into city values (178,'Lixge','BEL','Lixge',185639);
...
insert into city values (187,'Porto-Novo','BEN','Ouxmx',194000);
insert into city values (188,'Djougou','BEN','Atacora',134099);
insert into city values (189,'Parakou','BEN','Borgou',103577);
insert into city values (190,'Saint George','BMU','Saint Georgexs',1800);
...
insert into city values (199,'Potosx','BOL','Potosx',140642);
...
insert into city values (206,'Sxo Paulo','BRA','Sxo Paulo',9968485);
...
insert into city values (210,'Fortaleza','BRA','Cearx',2097757);
insert into city values (211,'Brasxlia','BRA','Distrito Federal',1969868);
insert into city values (212,'Curitiba','BRA','Paranx',1584232);
...
insert into city values (216,'Belxm','BRA','Parx',1186926);
insert into city values (217,'Guarulhos','BRA','Sxo Paulo',1095874);
insert into city values (218,'Goixnia','BRA','Goixs',1056330);
insert into city values (219,'Campinas','BRA','Sxo Paulo',950043);
insert into city values (220,'Sxo Gonxalo','BRA','Rio de Janeiro',869254);
insert into city values (221,'Nova Iguaxu','BRA','Rio de Janeiro',862225);
insert into city values (222,'Sxo Luxs','BRA','Maranhxo',837588);
insert into city values (223,'Maceix','BRA','Alagoas',786288);
insert into city values (224,'Duque de Caxias','BRA','Rio de Janeiro',746758);
insert into city values (225,'Sxo Bernardo do Campo','BRA','Sxo Paulo',723132);
insert into city values (226,'Teresina','BRA','Piaux',691942);
insert into city values (227,'Natal','BRA','Rio Grande do Norte',688955);
insert into city values (228,'Osasco','BRA','Sxo Paulo',659604);
insert into city values (229,'Campo Grande','BRA','Mato Grosso do Sul',649593);
insert into city values (230,'Santo Andrx','BRA','Sxo Paulo',630073);
insert into city values (231,'Joxo Pessoa','BRA','Paraxba',584029);
insert into city values (232,'Jaboatxo dos Guararapes','BRA','Pernambuco',558680);
insert into city values (233,'Contagem','BRA','Minas Gerais',520801);
insert into city values (234,'Sxo Josx dos Campos','BRA','Sxo Paulo',515553);
insert into city values (235,'Uberlxndia','BRA','Minas Gerais',487222);
insert into city values (236,'Feira de Santana','BRA','Bahia',479992);
insert into city values (237,'Ribeirxo Preto','BRA','Sxo Paulo',473276);
insert into city values (238,'Sorocaba','BRA','Sxo Paulo',466823);
insert into city values (239,'Niterxi','BRA','Rio de Janeiro',459884);
insert into city values (240,'Cuiabx','BRA','Mato Grosso',453813);
insert into city values (241,'Juiz de Fora','BRA','Minas Gerais',450288);
insert into city values (242,'Aracaju','BRA','Sergipe',445555);
insert into city values (243,'Sxo Joxo de Meriti','BRA','Rio de Janeiro',440052);
insert into city values (244,'Londrina','BRA','Paranx',432257);
...
insert into city values (247,'Santos','BRA','Sxo Paulo',408748);
insert into city values (248,'Ananindeua','BRA','Parx',400940);
insert into city values (249,'Campos dos Goytacazes','BRA','Rio de Janeiro',398418);
insert into city values (250,'Maux','BRA','Sxo Paulo',375055);
insert into city values (251,'Carapicuxba','BRA','Sxo Paulo',357552);
insert into city values (252,'Olinda','BRA','Pernambuco',354732);
insert into city values (253,'Campina Grande','BRA','Paraxba',352497);
insert into city values (254,'Sxo Josx do Rio Preto','BRA','Sxo Paulo',351944);
insert into city values (255,'Caxias do Sul','BRA','Rio Grande do Sul',349581);
insert into city values (256,'Moji das Cruzes','BRA','Sxo Paulo',339194);
insert into city values (257,'Diadema','BRA','Sxo Paulo',335078);
insert into city values (258,'Aparecida de Goixnia','BRA','Goixs',324662);
insert into city values (259,'Piracicaba','BRA','Sxo Paulo',319104);
insert into city values (260,'Cariacica','BRA','Espxrito Santo',319033);
insert into city values (261,'Vila Velha','BRA','Espxrito Santo',318758);
insert into city values (262,'Pelotas','BRA','Rio Grande do Sul',315415);
insert into city values (263,'Bauru','BRA','Sxo Paulo',313670);
insert into city values (264,'Porto Velho','BRA','Rondxnia',309750);
insert into city values (265,'Serra','BRA','Espxrito Santo',302666);
insert into city values (266,'Betim','BRA','Minas Gerais',302108);
insert into city values (267,'Jundxax','BRA','Sxo Paulo',296127);
insert into city values (268,'Canoas','BRA','Rio Grande do Sul',294125);
insert into city values (269,'Franca','BRA','Sxo Paulo',290139);
insert into city values (270,'Sxo Vicente','BRA','Sxo Paulo',286848);
insert into city values (271,'Maringx','BRA','Paranx',286461);
insert into city values (272,'Montes Claros','BRA','Minas Gerais',286058);
insert into city values (273,'Anxpolis','BRA','Goixs',282197);
insert into city values (274,'Florianxpolis','BRA','Santa Catarina',281928);
insert into city values (275,'Petrxpolis','BRA','Rio de Janeiro',279183);
insert into city values (276,'Itaquaquecetuba','BRA','Sxo Paulo',270874);
insert into city values (277,'Vitxria','BRA','Espxrito Santo',270626);
insert into city values (278,'Ponta Grossa','BRA','Paranx',268013);
insert into city values (279,'Rio Branco','BRA','Acre',259537);
insert into city values (280,'Foz do Iguaxu','BRA','Paranx',259425);
insert into city values (281,'Macapx','BRA','Amapx',256033);
insert into city values (282,'Ilhxus','BRA','Bahia',254970);
insert into city values (283,'Vitxria da Conquista','BRA','Bahia',253587);
insert into city values (284,'Uberaba','BRA','Minas Gerais',249225);
insert into city values (285,'Paulista','BRA','Pernambuco',248473);
insert into city values (286,'Limeira','BRA','Sxo Paulo',245497);
insert into city values (287,'Blumenau','BRA','Santa Catarina',244379);
insert into city values (288,'Caruaru','BRA','Pernambuco',244247);
insert into city values (289,'Santarxm','BRA','Parx',241771);
...
insert into city values (292,'Caucaia','BRA','Cearx',238738);
insert into city values (293,'Santa Maria','BRA','Rio Grande do Sul',238473);
insert into city values (294,'Cascavel','BRA','Paranx',237510);
insert into city values (295,'Guarujx','BRA','Sxo Paulo',237206);
insert into city values (296,'Ribeirxo das Neves','BRA','Minas Gerais',232685);
insert into city values (297,'Governador Valadares','BRA','Minas Gerais',231724);
insert into city values (298,'Taubatx','BRA','Sxo Paulo',229130);
insert into city values (299,'Imperatriz','BRA','Maranhxo',224564);
insert into city values (300,'Gravatax','BRA','Rio Grande do Sul',223011);
insert into city values (301,'Embu','BRA','Sxo Paulo',222223);
insert into city values (302,'Mossorx','BRA','Rio Grande do Norte',214901);
insert into city values (303,'Vxrzea Grande','BRA','Mato Grosso',214435);
insert into city values (304,'Petrolina','BRA','Pernambuco',210540);
insert into city values (305,'Barueri','BRA','Sxo Paulo',208426);
insert into city values (306,'Viamxo','BRA','Rio Grande do Sul',207557);
insert into city values (307,'Ipatinga','BRA','Minas Gerais',206338);
insert into city values (308,'Juazeiro','BRA','Bahia',201073);
insert into city values (309,'Juazeiro do Norte','BRA','Cearx',199636);
insert into city values (310,'Taboxo da Serra','BRA','Sxo Paulo',197550);
insert into city values (311,'Sxo Josx dos Pinhais','BRA','Paranx',196884);
insert into city values (312,'Magx','BRA','Rio de Janeiro',196147);
insert into city values (313,'Suzano','BRA','Sxo Paulo',195434);
insert into city values (314,'Sxo Leopoldo','BRA','Rio Grande do Sul',189258);
insert into city values (315,'Marxlia','BRA','Sxo Paulo',188691);
insert into city values (316,'Sxo Carlos','BRA','Sxo Paulo',187122);
insert into city values (317,'Sumarx','BRA','Sxo Paulo',186205);
insert into city values (318,'Presidente Prudente','BRA','Sxo Paulo',185340);
insert into city values (319,'Divinxpolis','BRA','Minas Gerais',185047);
...
insert into city values (323,'Jequix','BRA','Bahia',179128);
insert into city values (324,'Arapiraca','BRA','Alagoas',178988);
insert into city values (325,'Colombo','BRA','Paranx',177764);
insert into city values (326,'Americana','BRA','Sxo Paulo',177409);
insert into city values (327,'Alvorada','BRA','Rio Grande do Sul',175574);
insert into city values (328,'Araraquara','BRA','Sxo Paulo',174381);
insert into city values (329,'Itaborax','BRA','Rio de Janeiro',173977);
insert into city values (330,'Santa Bxrbara dxOeste','BRA','Sxo Paulo',171657);
insert into city values (331,'Nova Friburgo','BRA','Rio de Janeiro',170697);
insert into city values (332,'Jacarex','BRA','Sxo Paulo',170356);
insert into city values (333,'Araxatuba','BRA','Sxo Paulo',169303);
insert into city values (334,'Barra Mansa','BRA','Rio de Janeiro',168953);
insert into city values (335,'Praia Grande','BRA','Sxo Paulo',168434);
insert into city values (336,'Marabx','BRA','Parx',167795);
insert into city values (337,'Cricixma','BRA','Santa Catarina',167661);
...
insert into city values (342,'Rio Claro','BRA','Sxo Paulo',163551);
insert into city values (343,'Maracanax','BRA','Cearx',162022);
insert into city values (344,'Guarapuava','BRA','Paranx',160510);
insert into city values (345,'Rondonxpolis','BRA','Mato Grosso',155115);
insert into city values (346,'Sxo Josx','BRA','Santa Catarina',155105);
insert into city values (347,'Cachoeiro de Itapemirim','BRA','Espxrito Santo',155024);
insert into city values (348,'Nilxpolis','BRA','Rio de Janeiro',153383);
insert into city values (349,'Itapevi','BRA','Sxo Paulo',150664);
insert into city values (350,'Cabo de Santo Agostinho','BRA','Pernambuco',149964);
insert into city values (351,'Camaxari','BRA','Bahia',149146);
insert into city values (352,'Sobral','BRA','Cearx',146005);
insert into city values (353,'Itajax','BRA','Santa Catarina',145197);
insert into city values (354,'Chapecx','BRA','Santa Catarina',144158);
insert into city values (355,'Cotia','BRA','Sxo Paulo',140042);
insert into city values (356,'Lages','BRA','Santa Catarina',139570);
insert into city values (357,'Ferraz de Vasconcelos','BRA','Sxo Paulo',139283);
insert into city values (358,'Indaiatuba','BRA','Sxo Paulo',135968);
insert into city values (359,'Hortolxndia','BRA','Sxo Paulo',135755);
insert into city values (360,'Caxias','BRA','Maranhxo',133980);
insert into city values (361,'Sxo Caetano do Sul','BRA','Sxo Paulo',133321);
insert into city values (362,'Itu','BRA','Sxo Paulo',132736);
insert into city values (363,'Nossa Senhora do Socorro','BRA','Sergipe',131351);
insert into city values (364,'Parnaxba','BRA','Piaux',129756);
insert into city values (365,'Poxos de Caldas','BRA','Minas Gerais',129683);
insert into city values (366,'Teresxpolis','BRA','Rio de Janeiro',128079);
insert into city values (367,'Barreiras','BRA','Bahia',127801);
insert into city values (368,'Castanhal','BRA','Parx',127634);
insert into city values (369,'Alagoinhas','BRA','Bahia',126820);
insert into city values (370,'Itapecerica da Serra','BRA','Sxo Paulo',126672);
insert into city values (371,'Uruguaiana','BRA','Rio Grande do Sul',126305);
insert into city values (372,'Paranagux','BRA','Paranx',126076);
insert into city values (373,'Ibiritx','BRA','Minas Gerais',125982);
insert into city values (374,'Timon','BRA','Maranhxo',125812);
insert into city values (375,'Luzixnia','BRA','Goixs',125597);
insert into city values (376,'Macax','BRA','Rio de Janeiro',125597);
insert into city values (377,'Texfilo Otoni','BRA','Minas Gerais',124489);
insert into city values (378,'Moji-Guaxu','BRA','Sxo Paulo',123782);
insert into city values (379,'Palmas','BRA','Tocantins',121919);
insert into city values (380,'Pindamonhangaba','BRA','Sxo Paulo',121904);
insert into city values (381,'Francisco Morato','BRA','Sxo Paulo',121197);
insert into city values (382,'Bagx','BRA','Rio Grande do Sul',120793);
...
insert into city values (385,'Itapetininga','BRA','Sxo Paulo',119391);
...
insert into city values (388,'Braganxa Paulista','BRA','Sxo Paulo',116929);
insert into city values (389,'Queimados','BRA','Rio de Janeiro',115020);
insert into city values (390,'Araguaxna','BRA','Tocantins',114948);
insert into city values (391,'Garanhuns','BRA','Pernambuco',114603);
insert into city values (392,'Vitxria de Santo Antxo','BRA','Pernambuco',113595);
insert into city values (393,'Santa Rita','BRA','Paraxba',113135);
insert into city values (394,'Barbacena','BRA','Minas Gerais',113079);
insert into city values (395,'Abaetetuba','BRA','Parx',111258);
insert into city values (396,'Jax','BRA','Sxo Paulo',109965);
insert into city values (397,'Lauro de Freitas','BRA','Bahia',109236);
insert into city values (398,'Franco da Rocha','BRA','Sxo Paulo',108964);
...
insert into city values (401,'Ribeirxo Pires','BRA','Sxo Paulo',108121);
insert into city values (402,'Sabarx','BRA','Minas Gerais',107781);
insert into city values (403,'Catanduva','BRA','Sxo Paulo',107761);
insert into city values (404,'Rio Verde','BRA','Goixs',107755);
insert into city values (405,'Botucatu','BRA','Sxo Paulo',107663);
insert into city values (406,'Colatina','BRA','Espxrito Santo',107354);
insert into city values (407,'Santa Cruz do Sul','BRA','Rio Grande do Sul',106734);
insert into city values (408,'Linhares','BRA','Espxrito Santo',106278);
insert into city values (409,'Apucarana','BRA','Paranx',105114);
insert into city values (410,'Barretos','BRA','Sxo Paulo',104156);
insert into city values (411,'Guaratinguetx','BRA','Sxo Paulo',103433);
insert into city values (412,'Cachoeirinha','BRA','Rio Grande do Sul',103240);
insert into city values (413,'Codx','BRA','Maranhxo',103153);
insert into city values (414,'Jaragux do Sul','BRA','Santa Catarina',102580);
insert into city values (415,'Cubatxo','BRA','Sxo Paulo',102372);
insert into city values (416,'Itabira','BRA','Minas Gerais',102217);
insert into city values (417,'Itaituba','BRA','Parx',101320);
insert into city values (418,'Araras','BRA','Sxo Paulo',101046);
insert into city values (419,'Resende','BRA','Rio de Janeiro',100627);
insert into city values (420,'Atibaia','BRA','Sxo Paulo',100356);
insert into city values (421,'Pouso Alegre','BRA','Minas Gerais',100028);
insert into city values (422,'Toledo','BRA','Paranx',99387);
insert into city values (423,'Crato','BRA','Cearx',98965);
insert into city values (424,'Passos','BRA','Minas Gerais',98570);
insert into city values (425,'Araguari','BRA','Minas Gerais',98399);
insert into city values (426,'Sxo Josx de Ribamar','BRA','Maranhxo',98318);
insert into city values (427,'Pinhais','BRA','Paranx',98198);
insert into city values (428,'Sertxozinho','BRA','Sxo Paulo',98140);
...
insert into city values (432,'Eunxpolis','BRA','Bahia',96610);
insert into city values (433,'Salto','BRA','Sxo Paulo',96348);
insert into city values (434,'Ourinhos','BRA','Sxo Paulo',96291);
...
insert into city values (438,'Birigui','BRA','Sxo Paulo',94685);
insert into city values (439,'Tatux','BRA','Sxo Paulo',93897);
insert into city values (440,'Ji-Paranx','BRA','Rondxnia',93346);
insert into city values (441,'Bacabal','BRA','Maranhxo',93121);
insert into city values (442,'Cametx','BRA','Parx',92779);
insert into city values (443,'Guaxba','BRA','Rio Grande do Sul',92224);
insert into city values (444,'Sxo Lourenxo da Mata','BRA','Pernambuco',91999);
insert into city values (445,'Santana do Livramento','BRA','Rio Grande do Sul',91779);
insert into city values (446,'Votorantim','BRA','Sxo Paulo',91777);
insert into city values (447,'Campo Largo','BRA','Paranx',91203);
insert into city values (448,'Patos','BRA','Paraxba',90519);
insert into city values (449,'Ituiutaba','BRA','Minas Gerais',90507);
insert into city values (450,'Corumbx','BRA','Mato Grosso do Sul',90111);
insert into city values (451,'Palhoxa','BRA','Santa Catarina',89465);
insert into city values (452,'Barra do Pirax','BRA','Rio de Janeiro',89388);
insert into city values (453,'Bento Gonxalves','BRA','Rio Grande do Sul',89254);
insert into city values (454,'Pox','BRA','Sxo Paulo',89236);
insert into city values (455,'xguas Lindas de Goixs','BRA','Goixs',89200);
...
insert into city values (536,'Douglas','GBR','x',23487);
...
insert into city values (556,'Vixa del Mar','CHL','Valparaxso',312493);
insert into city values (557,'Valparaxso','CHL','Valparaxso',293800);
insert into city values (558,'Talcahuano','CHL','Bxobxo',277752);
...
insert into city values (561,'Temuco','CHL','La Araucanxa',233041);
insert into city values (562,'Concepcixn','CHL','Bxobxo',217664);
insert into city values (563,'Rancagua','CHL','OxHiggins',212977);
insert into city values (564,'Arica','CHL','Tarapacx',189036);
insert into city values (565,'Talca','CHL','Maule',187557);
insert into city values (566,'Chillxn','CHL','Bxobxo',178182);
insert into city values (567,'Iquique','CHL','Tarapacx',177892);
insert into city values (568,'Los Angeles','CHL','Bxobxo',158215);
...
insert into city values (576,'Copiapx','CHL','Atacama',120128);
insert into city values (577,'Quilpux','CHL','Valparaxso',118857);
insert into city values (578,'Curicx','CHL','Maule',115766);
insert into city values (579,'Ovalle','CHL','Coquimbo',94854);
insert into city values (580,'Coronel','CHL','Bxobxo',93061);
insert into city values (581,'San Pedro de la Paz','CHL','Bxobxo',91684);
insert into city values (582,'Melipilla','CHL','Santiago',91056);
insert into city values (583,'Avarua','COK','Rarotonga',11900);
insert into city values (584,'San Josx','CRI','San Josx',339131);
insert into city values (585,'Djibouti','DJI','Djibouti',383000);
insert into city values (586,'Roseau','DMA','St George',16243);
insert into city values (587,'Santo Domingo de Guzmxn','DOM','Distrito Nacional',1609966);
...
insert into city values (590,'San Pedro de Macorxs','DOM','San Pedro de Macorxs',124735);
insert into city values (591,'San Francisco de Macorxs','DOM','Duarte',108485);
...
insert into city values (658,'Mxlaga','ESP','Andalusia',530553);
...
insert into city values (663,'Valladolid','ESP','Castilla and Lexn',319998);
insert into city values (664,'Cxrdoba','ESP','Andalusia',311708);
insert into city values (665,'Vigo','ESP','Galicia',283670);
insert into city values (666,'Alicante [Alacant]','ESP','Valencia',272432);
insert into city values (667,'Gijxn','ESP','Asturia',267980);
insert into city values (668,'LxHospitalet de Llobregat','ESP','Katalonia',247986);
insert into city values (669,'Granada','ESP','Andalusia',244767);
insert into city values (670,'A Coruxa (La Coruxa)','ESP','Galicia',243402);
...
insert into city values (675,'Mxstoles','ESP','Madrid',195351);
...
insert into city values (680,'Pamplona [Iruxa]','ESP','Navarra',180483);
insert into city values (681,'Donostia-San Sebastixn','ESP','Baskimaa',179208);
insert into city values (682,'Cartagena','ESP','Murcia',177709);
insert into city values (683,'Leganxs','ESP','Madrid',173163);
insert into city values (684,'Fuenlabrada','ESP','Madrid',171173);
insert into city values (685,'Almerxa','ESP','Andalusia',169027);
insert into city values (686,'Terrassa','ESP','Katalonia',168695);
insert into city values (687,'Alcalx de Henares','ESP','Madrid',164463);
insert into city values (688,'Burgos','ESP','Castilla and Lexn',162802);
insert into city values (689,'Salamanca','ESP','Castilla and Lexn',158720);
insert into city values (690,'Albacete','ESP','Kastilia-La Mancha',147527);
insert into city values (691,'Getafe','ESP','Madrid',145371);
insert into city values (692,'Cxdiz','ESP','Andalusia',142449);
insert into city values (693,'Alcorcxn','ESP','Madrid',142048);
insert into city values (694,'Huelva','ESP','Andalusia',140583);
insert into city values (695,'Lexn','ESP','Castilla and Lexn',139809);
insert into city values (696,'Castellxn de la Plana [Castell','ESP','Valencia',139712);
insert into city values (697,'Badajoz','ESP','Extremadura',136613);
insert into city values (698,'[San Cristxbal de] la Laguna','ESP','Canary Islands',127945);
insert into city values (699,'Logroxo','ESP','La Rioja',127093);
...
insert into city values (702,'Lleida (Lxrida)','ESP','Katalonia',112207);
insert into city values (703,'Jaxn','ESP','Andalusia',109247);
insert into city values (704,'Ourense (Orense)','ESP','Galicia',109120);
insert into city values (705,'Matarx','ESP','Katalonia',104095);
...
insert into city values (711,'Torrejxn de Ardoz','ESP','Madrid',92262);
...
insert into city values (773,'Las Pixas','PHL','National Capital Reg',472780);
...
insert into city values (777,'Paraxaque','PHL','National Capital Reg',449811);
...
insert into city values (782,'Dasmarixas','PHL','Southern Tagalog',379520);
...
insert into city values (787,'San Josx del Monte','PHL','Central Luzon',315807);
...
insert into city values (806,'Bixan','PHL','Southern Tagalog',201186);
...
insert into city values (901,'Txrshavn','FRO','Streymoyar',14542);
...
insert into city values (908,'Batumi','GEO','Adzaria [Atxara]',137700);
...
insert into city values (915,'Gibraltar','GIB','x',27025);
insert into city values (916,'Saint Georgexs','GRD','St George',4621);
...
insert into city values (920,'Tamuning','GUM','x',9500);
insert into city values (921,'Agaxa','GUM','x',1139);
...
insert into city values (932,'Le-Cap-Haxtien','HTI','Nord',102233);
insert into city values (933,'Tegucigalpa','HND','Distrito Central',813900);
insert into city values (934,'San Pedro Sula','HND','Cortxs',383900);
insert into city values (935,'La Ceiba','HND','Atlxntida',89200);
...
insert into city values (938,'Longyearbyen','SJM','Lxnsimaa',1438);
...
insert into city values (1449,'Reykjavxk','ISL','Hxfuxborgarsvxxi',109184);
...
insert into city values (1489,'Reggio nellx Emilia','ITA','Emilia-Romagna',143664);
...
insert into city values (1502,'Forlx','ITA','Emilia-Romagna',107475);
...
insert into city values (1528,'Klagenfurt','AUT','Kxrnten',91141);
...
insert into city values (1791,'Flying Fish Cove','CXR','x',700);
...
insert into city values (1794,'Nix','YUG','Central Serbia',175391);
insert into city values (1795,'Prixtina','YUG','Kosovo and Metohija',155496);
...
insert into city values (1804,'Yaoundx','CMR','Centre',1372800);
insert into city values (1805,'Garoua','CMR','Nord',177000);
insert into city values (1806,'Maroua','CMR','Extrxme-Nord',143000);
...
insert into city values (1810,'Montrxal','CAN','Quxbec',1016376);
...
insert into city values (1823,'Laval','CAN','Quxbec',330393);
...
insert into city values (1832,'Quxbec','CAN','Quxbec',167264);
...
insert into city values (1840,'Longueuil','CAN','Quxbec',127977);
...
insert into city values (1851,'Saint Johnxs','CAN','Newfoundland',101936);
...
insert into city values (1854,'Gatineau','CAN','Quxbec',100702);
...
insert into city values (1859,'Praia','CPV','Sxo Tiago',94800);
...
insert into city values (1877,'Kxkshetau','KAZ','North Kazakstan',123400);
...
insert into city values (1901,'Xixan','CHN','Shaanxi',2761400);
...
insert into city values (1917,'Urumtxi [xrxmqi]','CHN','Xinxiang',1310100);
...
insert into city values (1991,'Taixan','CHN','Shandong',350696);
...
insert into city values (2005,'Maxanshan','CHN','Anhui',305421);
...
insert into city values (2065,'Beixan','CHN','Heilongjiang',204899);
...
insert into city values (2128,'Ruixan','CHN','Zhejiang',156468);
...
insert into city values (2137,'Jixan','CHN','Jiangxi',148583);
...
insert into city values (2144,'Liuxan','CHN','Anhui',144248);
...
insert into city values (2150,'Daxan','CHN','Jilin',138963);
...
insert into city values (2171,'Huaixan','CHN','Jiangsu',131149);
...
insert into city values (2202,'Yanxan','CHN','Shaanxi',113277);
...
insert into city values (2206,'Yongxan','CHN','Fujian',111762);
...
insert into city values (2218,'Fuxan','CHN','Fujian',105265);
...
insert into city values (2237,'Yaxan','CHN','Sichuan',95900);
...
insert into city values (2257,'Santafx de Bogotx','COL','Santafx de Bogotx',6260862);
insert into city values (2258,'Cali','COL','Valle',2077386);
insert into city values (2259,'Medellxn','COL','Antioquia',1861265);
insert into city values (2260,'Barranquilla','COL','Atlxntico',1223260);
insert into city values (2261,'Cartagena','COL','Bolxvar',805757);
insert into city values (2262,'Cxcuta','COL','Norte de Santander',606932);
insert into city values (2263,'Bucaramanga','COL','Santander',515555);
insert into city values (2264,'Ibagux','COL','Tolima',393664);
...
insert into city values (2269,'Pasto','COL','Narixo',332396);
insert into city values (2270,'Neiva','COL','Huila',300052);
insert into city values (2271,'Soledad','COL','Atlxntico',295058);
insert into city values (2272,'Armenia','COL','Quindxo',288977);
...
insert into city values (2276,'Monterxa','COL','Cxrdoba',248245);
insert into city values (2277,'Itagxx','COL','Antioquia',228985);
...
insert into city values (2282,'Popayxn','COL','Cauca',200719);
...
insert into city values (2285,'Tulux','COL','Valle',152488);
...
insert into city values (2290,'Tunja','COL','Boyacx',109740);
insert into city values (2291,'Florencia','COL','Caquetx',108574);
insert into city values (2292,'Maicao','COL','La Guajira',108053);
insert into city values (2293,'Sogamoso','COL','Boyacx',107728);
...
insert into city values (2302,'Kisangani','COD','Haute-Zaxre',417517);
...
insert into city values (2415,'Camagxey','CUB','Camagxey',298726);
insert into city values (2416,'Holguxn','CUB','Holguxn',249492);
insert into city values (2417,'Santa Clara','CUB','Villa Clara',207350);
insert into city values (2418,'Guantxnamo','CUB','Guantxnamo',205078);
insert into city values (2419,'Pinar del Rxo','CUB','Pinar del Rxo',142100);
...
insert into city values (2425,'Sancti-Spxritus','CUB','Sancti-Spxritus',100751);
insert into city values (2426,'Ciego de xvila','CUB','Ciego de xvila',98505);
...
insert into city values (2450,'xiauliai','LTU','xiauliai',146563);
insert into city values (2451,'Panevezys','LTU','Panevezys',133695);
insert into city values (2452,'Luxembourg [Luxemburg/Lxtzebuerg]','LUX','Luxembourg',80700);
insert into city values (2453,'El-Aaixn','ESH','El-Aaixn',169000);
...
insert into city values (2457,'Antsirabx','MDG','Antananarivo',120239);
...
insert into city values (2486,'Rabat','MAR','Rabat-Salx-Zammour-Z',623457);
insert into city values (2487,'Marrakech','MAR','Marrakech-Tensift-Al',621914);
insert into city values (2488,'Fxs','MAR','Fxs-Boulemane',541162);
insert into city values (2489,'Tanger','MAR','Tanger-Txtouan',521735);
insert into city values (2490,'Salx','MAR','Rabat-Salx-Zammour-Z',504420);
insert into city values (2491,'Meknxs','MAR','Meknxs-Tafilalet',460000);
insert into city values (2492,'Oujda','MAR','Oriental',365382);
insert into city values (2493,'Kxnitra','MAR','Gharb-Chrarda-Bxni H',292600);
insert into city values (2494,'Txtouan','MAR','Tanger-Txtouan',277516);
insert into city values (2495,'Safi','MAR','Doukkala-Abda',262300);
insert into city values (2496,'Agadir','MAR','Souss Massa-Drax',155244);
...
insert into city values (2500,'Txmara','MAR','Rabat-Salx-Zammour-Z',126303);
insert into city values (2501,'El Jadida','MAR','Doukkala-Abda',119083);
insert into city values (2502,'Nador','MAR','Oriental',112450);
insert into city values (2503,'Ksar el Kebir','MAR','Tanger-Txtouan',107065);
...
insert into city values (2506,'El Araich','MAR','Tanger-Txtouan',90400);
...
insert into city values (2510,'Nouxdhibou','MRT','Dakhlet Nouxdhibou',97600);
...
insert into city values (2515,'Ciudad de Mxxico','MEX','Distrito Federal',8591309);
insert into city values (2516,'Guadalajara','MEX','Jalisco',1647720);
insert into city values (2517,'Ecatepec de Morelos','MEX','Mxxico',1620303);
insert into city values (2518,'Puebla','MEX','Puebla',1346176);
insert into city values (2519,'Nezahualcxyotl','MEX','Mxxico',1224924);
insert into city values (2520,'Juxrez','MEX','Chihuahua',1217818);
insert into city values (2521,'Tijuana','MEX','Baja California',1212232);
insert into city values (2522,'Lexn','MEX','Guanajuato',1133576);
insert into city values (2523,'Monterrey','MEX','Nuevo Lexn',1108499);
insert into city values (2524,'Zapopan','MEX','Jalisco',1002239);
insert into city values (2525,'Naucalpan de Juxrez','MEX','Mxxico',857511);
insert into city values (2526,'Mexicali','MEX','Baja California',764902);
insert into city values (2527,'Culiacxn','MEX','Sinaloa',744859);
insert into city values (2528,'Acapulco de Juxrez','MEX','Guerrero',721011);
insert into city values (2529,'Tlalnepantla de Baz','MEX','Mxxico',720755);
insert into city values (2530,'Mxrida','MEX','Yucatxn',703324);
insert into city values (2531,'Chihuahua','MEX','Chihuahua',670208);
insert into city values (2532,'San Luis Potosx','MEX','San Luis Potosx',669353);
insert into city values (2533,'Guadalupe','MEX','Nuevo Lexn',668780);
insert into city values (2534,'Toluca','MEX','Mxxico',665617);
insert into city values (2535,'Aguascalientes','MEX','Aguascalientes',643360);
insert into city values (2536,'Querxtaro','MEX','Querxtaro de Arteaga',639839);
insert into city values (2537,'Morelia','MEX','Michoacxn de Ocampo',619958);
...
insert into city values (2540,'Torrexn','MEX','Coahuila de Zaragoza',529093);
insert into city values (2541,'Centro (Villahermosa)','MEX','Tabasco',519873);
insert into city values (2542,'San Nicolxs de los Garza','MEX','Nuevo Lexn',495540);
insert into city values (2543,'Durango','MEX','Durango',490524);
insert into city values (2544,'Chimalhuacxn','MEX','Mxxico',490245);
insert into city values (2545,'Tlaquepaque','MEX','Jalisco',475472);
insert into city values (2546,'Atizapxn de Zaragoza','MEX','Mxxico',467262);
insert into city values (2547,'Veracruz','MEX','Veracruz',457119);
insert into city values (2548,'Cuautitlxn Izcalli','MEX','Mxxico',452976);
insert into city values (2549,'Irapuato','MEX','Guanajuato',440039);
insert into city values (2550,'Tuxtla Gutixrrez','MEX','Chiapas',433544);
insert into city values (2551,'Tultitlxn','MEX','Mxxico',432411);
insert into city values (2552,'Reynosa','MEX','Tamaulipas',419776);
insert into city values (2553,'Benito Juxrez','MEX','Quintana Roo',419276);
...
insert into city values (2557,'Mazatlxn','MEX','Sinaloa',380265);
...
insert into city values (2562,'Tonalx','MEX','Jalisco',336109);
insert into city values (2563,'Valle de Chalco Solidaridad','MEX','Mxxico',323113);
...
insert into city values (2567,'Ixtapaluca','MEX','Mxxico',293160);
insert into city values (2568,'Apodaca','MEX','Nuevo Lexn',282941);
insert into city values (2569,'Guasave','MEX','Sinaloa',277201);
insert into city values (2570,'Gxmez Palacio','MEX','Durango',272806);
insert into city values (2571,'Tapachula','MEX','Chiapas',271141);
insert into city values (2572,'Nicolxs Romero','MEX','Mxxico',269393);
insert into city values (2573,'Coatzacoalcos','MEX','Veracruz',267037);
insert into city values (2574,'Uruapan','MEX','Michoacxn de Ocampo',265211);
insert into city values (2575,'Victoria','MEX','Tamaulipas',262686);
insert into city values (2576,'Oaxaca de Juxrez','MEX','Oaxaca',256848);
insert into city values (2577,'Coacalco de Berriozxbal','MEX','Mxxico',252270);
insert into city values (2578,'Pachuca de Soto','MEX','Hidalgo',244688);
insert into city values (2579,'General Escobedo','MEX','Nuevo Lexn',232961);
insert into city values (2580,'Salamanca','MEX','Guanajuato',226864);
insert into city values (2581,'Santa Catarina','MEX','Nuevo Lexn',226573);
insert into city values (2582,'Tehuacxn','MEX','Puebla',225943);
insert into city values (2583,'Chalco','MEX','Mxxico',222201);
insert into city values (2584,'Cxrdenas','MEX','Tabasco',216903);
insert into city values (2585,'Campeche','MEX','Campeche',216735);
insert into city values (2586,'La Paz','MEX','Mxxico',213045);
insert into city values (2587,'Othxn P. Blanco (Chetumal)','MEX','Quintana Roo',208014);
insert into city values (2588,'Texcoco','MEX','Mxxico',203681);
insert into city values (2589,'La Paz','MEX','Baja California Sur',196708);
insert into city values (2590,'Metepec','MEX','Mxxico',194265);
insert into city values (2591,'Monclova','MEX','Coahuila de Zaragoza',193657);
insert into city values (2592,'Huixquilucan','MEX','Mxxico',193156);
...
insert into city values (2597,'Soledad de Graciano Sxnchez','MEX','San Luis Potosx',179956);
insert into city values (2598,'San Juan del Rxo','MEX','Querxtaro',179300);
insert into city values (2599,'San Felipe del Progreso','MEX','Mxxico',177330);
insert into city values (2600,'Cxrdoba','MEX','Veracruz',176952);
insert into city values (2601,'Tecxmac','MEX','Mxxico',172410);
insert into city values (2602,'Ocosingo','MEX','Chiapas',171495);
insert into city values (2603,'Carmen','MEX','Campeche',171367);
insert into city values (2604,'Lxzaro Cxrdenas','MEX','Michoacxn de Ocampo',170878);
...
insert into city values (2608,'Zamora','MEX','Michoacxn de Ocampo',161191);
...
insert into city values (2612,'Minatitlxn','MEX','Veracruz',152983);
insert into city values (2613,'Poza Rica de Hidalgo','MEX','Veracruz',152678);
insert into city values (2614,'Ciudad Valles','MEX','San Luis Potosx',146411);
insert into city values (2615,'Navolato','MEX','Sinaloa',145396);
insert into city values (2616,'San Luis Rxo Colorado','MEX','Sonora',145276);
insert into city values (2617,'Pxnjamo','MEX','Guanajuato',143927);
insert into city values (2618,'San Andrxs Tuxtla','MEX','Veracruz',142251);
insert into city values (2619,'Guanajuato','MEX','Guanajuato',141215);
insert into city values (2620,'Navojoa','MEX','Sonora',140495);
insert into city values (2621,'Zitxcuaro','MEX','Michoacxn de Ocampo',137970);
insert into city values (2622,'Boca del Rxo','MEX','Veracruz-Llave',135721);
...
insert into city values (2627,'San Cristxbal de las Casas','MEX','Chiapas',132317);
...
insert into city values (2635,'Txxpam','MEX','Veracruz',126475);
insert into city values (2636,'San Pedro Garza Garcxa','MEX','Nuevo Lexn',126147);
insert into city values (2637,'Cuauhtxmoc','MEX','Chihuahua',124279);
...
insert into city values (2641,'Tlajomulco de Zxxiga','MEX','Jalisco',123220);
insert into city values (2642,'Tulancingo de Bravo','MEX','Hidalgo',121946);
insert into city values (2643,'Zinacantepec','MEX','Mxxico',121715);
insert into city values (2644,'San Martxn Texmelucan','MEX','Puebla',121093);
insert into city values (2645,'Tepatitlxn de Morelos','MEX','Jalisco',118948);
insert into city values (2646,'Martxnez de la Torre','MEX','Veracruz',118815);
insert into city values (2647,'Orizaba','MEX','Veracruz',118488);
insert into city values (2648,'Apatzingxn','MEX','Michoacxn de Ocampo',117849);
insert into city values (2649,'Atlixco','MEX','Puebla',117019);
insert into city values (2650,'Delicias','MEX','Chihuahua',116132);
insert into city values (2651,'Ixtlahuaca','MEX','Mxxico',115548);
insert into city values (2652,'El Mante','MEX','Tamaulipas',112453);
insert into city values (2653,'Lerdo','MEX','Durango',112272);
insert into city values (2654,'Almoloya de Juxrez','MEX','Mxxico',110550);
insert into city values (2655,'Acxmbaro','MEX','Guanajuato',110487);
insert into city values (2656,'Acuxa','MEX','Coahuila de Zaragoza',110388);
...
insert into city values (2659,'Hidalgo','MEX','Michoacxn de Ocampo',106198);
insert into city values (2660,'Los Cabos','MEX','Baja California Sur',105199);
insert into city values (2661,'Comitxn de Domxnguez','MEX','Chiapas',104986);
insert into city values (2662,'Cunduacxn','MEX','Tabasco',104164);
insert into city values (2663,'Rxo Bravo','MEX','Tamaulipas',103901);
...
insert into city values (2667,'San Francisco del Rincxn','MEX','Guanajuato',100149);
insert into city values (2668,'Taxco de Alarcxn','MEX','Guerrero',99907);
insert into city values (2669,'Zumpango','MEX','Mxxico',99781);
insert into city values (2670,'San Pedro Cholula','MEX','Puebla',99734);
insert into city values (2671,'Lerma','MEX','Mxxico',99714);
insert into city values (2672,'Tecomxn','MEX','Colima',99296);
...
insert into city values (2676,'Josx Azueta','MEX','Guerrero',95448);
...
insert into city values (2685,'Pxnuco','MEX','Veracruz',90551);
...
insert into city values (2693,'Bender (Txghina)','MDA','Bender (Txghina)',125700);
insert into city values (2694,'Monte-Carlo','MCO','x',13154);
insert into city values (2695,'Monaco-Ville','MCO','x',1234);
...
insert into city values (2703,'Naxala-Porto','MOZ','Nampula',158248);
insert into city values (2704,'Quelimane','MOZ','Zambxzia',150116);
insert into city values (2705,'Mocuba','MOZ','Zambxzia',124700);
insert into city values (2706,'Tete','MOZ','Tete',101984);
insert into city values (2707,'Xai-Xai','MOZ','Gaza',99442);
insert into city values (2708,'Gurue','MOZ','Zambxzia',99300);
...
insert into city values (2727,'Yangor','NRU','x',4050);
insert into city values (2728,'Yaren','NRU','x',559);
...
insert into city values (2735,'Lexn','NIC','Lexn',123865);
...
insert into city values (2805,'Alofi','NIU','x',682);
insert into city values (2806,'Kingston','NFK','x',800);
insert into city values (2807,'Oslo','NOR','Oslo',508726);
insert into city values (2808,'Bergen','NOR','Hordaland',230948);
insert into city values (2809,'Trondheim','NOR','Sxr-Trxndelag',150166);
insert into city values (2810,'Stavanger','NOR','Rogaland',108848);
insert into city values (2811,'Bxrum','NOR','Akershus',101340);
insert into city values (2812,'Abidjan','CIV','Abidjan',2500000);
insert into city values (2813,'Bouakx','CIV','Bouakx',329850);
...
insert into city values (2882,'Ciudad de Panamx','PAN','Panamx',471373);
...
insert into city values (2885,'Asuncixn','PRY','Asuncixn',557776);
insert into city values (2886,'Ciudad del Este','PRY','Alto Paranx',133881);
insert into city values (2887,'San Lorenzo','PRY','Central',133395);
insert into city values (2888,'Lambarx','PRY','Central',99681);
...
insert into city values (2897,'Huancayo','PER','Junxn',327000);
...
insert into city values (2905,'Huxnuco','PER','Huanuco',129688);
...
insert into city values (2912,'Adamstown','PCN','x',42);
...
insert into city values (2917,'Coxmbra','PRT','Coxmbra',96100);
insert into city values (2918,'Braga','PRT','Braga',90535);
insert into city values (2919,'San Juan','PRI','San Juan',434374);
insert into city values (2920,'Bayamxn','PRI','Bayamxn',224044);
...
insert into city values (2926,'Mayagxez','PRI','Mayagxez',98434);
insert into city values (2927,'Toa Baja','PRI','Toa Baja',94085);
insert into city values (2928,'Warszawa','POL','Mazowieckie',1615369);
insert into city values (2929,'Lxdz','POL','Lodzkie',800110);
insert into city values (2930,'Krakxw','POL','Malopolskie',738150);
...
insert into city values (2950,'Rzeszxw','POL','Podkarpackie',162049);
...
insert into city values (2955,'Dabrowa Gxrnicza','POL','Slaskie',131037);
...
insert into city values (2959,'Gorzxw Wielkopolski','POL','Lubuskie',126019);
insert into city values (2960,'Wloclawek','POL','Kujawsko-Pomorskie',123373);
insert into city values (2961,'Chorzxw','POL','Slaskie',121708);
insert into city values (2962,'Tarnxw','POL','Malopolskie',121494);
insert into city values (2963,'Zielona Gxra','POL','Lubuskie',118182);
...
insert into city values (2969,'Jastrzebie-Zdrxj','POL','Slaskie',102294);
insert into city values (2970,'Jaworzno','POL','Slaskie',97929);
insert into city values (2971,'Jelenia Gxra','POL','Dolnoslaskie',93901);
insert into city values (2972,'Malabo','GNQ','Bioko',40000);
insert into city values (2973,'Doha','QAT','Doha',355000);
insert into city values (2974,'Paris','FRA','xle-de-France',2125246);
insert into city values (2975,'Marseille','FRA','Provence-Alpes-Cxte',798430);
insert into city values (2976,'Lyon','FRA','Rhxne-Alpes',445452);
insert into city values (2977,'Toulouse','FRA','Midi-Pyrxnxes',390350);
insert into city values (2978,'Nice','FRA','Provence-Alpes-Cxte',342738);
...
insert into city values (2986,'Lille','FRA','Rhxne-Alpes',184657);
insert into city values (2987,'St-xtienne','FRA','Bretagne',180210);
insert into city values (2988,'Toulon','FRA','Provence-Alpes-Cxte',160639);
insert into city values (2989,'Grenoble','FRA','Rhxne-Alpes',153317);
...
insert into city values (2996,'Aix-en-Provence','FRA','Provence-Alpes-Cxte',134222);
insert into city values (2997,'Limoges','FRA','Limousin',133968);
insert into city values (2998,'Nxmes','FRA','Languedoc-Roussillon',133424);
insert into city values (2999,'Tours','FRA','Centre',132820);
insert into city values (3000,'Villeurbanne','FRA','Rhxne-Alpes',124215);
insert into city values (3001,'Metz','FRA','Lorraine',123776);
insert into city values (3002,'Besanxon','FRA','Franche-Comtx',117733);
insert into city values (3003,'Caen','FRA','Basse-Normandie',113987);
insert into city values (3004,'Orlxans','FRA','Centre',113126);
insert into city values (3005,'Mulhouse','FRA','Alsace',110359);
insert into city values (3006,'Rouen','FRA','Haute-Normandie',106592);
insert into city values (3007,'Boulogne-Billancourt','FRA','xle-de-France',106367);
...
insert into city values (3011,'Argenteuil','FRA','xle-de-France',93961);
insert into city values (3012,'Tourcoing','FRA','Nord-Pas-de-Calais',93540);
insert into city values (3013,'Montreuil','FRA','xle-de-France',90674);
...
insert into city values (3033,'Txrgu Mures','ROM','Mures',165153);
...
insert into city values (3039,'Rxmnicu Vxlcea','ROM','Vxlcea',119741);
...
insert into city values (3042,'Txrgoviste','ROM','Dxmbovita',98980);
insert into city values (3043,'Focsani','ROM','Vrancea',98979);
insert into city values (3044,'Txrgu Jiu','ROM','Gorj',98524);
...
insert into city values (3049,'Gothenburg [Gxteborg]','SWE','West Gxtanmaan lxn',466990);
insert into city values (3050,'Malmx','SWE','Skxne lxn',259579);
insert into city values (3051,'Uppsala','SWE','Uppsala lxn',189569);
insert into city values (3052,'Linkxping','SWE','East Gxtanmaan lxn',133168);
insert into city values (3053,'Vxsterxs','SWE','Vxstmanlands lxn',126328);
insert into city values (3054,'xrebro','SWE','xrebros lxn',124207);
insert into city values (3055,'Norrkxping','SWE','East Gxtanmaan lxn',122199);
insert into city values (3056,'Helsingborg','SWE','Skxne lxn',117737);
insert into city values (3057,'Jxnkxping','SWE','Jxnkxpings lxn',117095);
insert into city values (3058,'Umex','SWE','Vxsterbottens lxn',104512);
insert into city values (3059,'Lund','SWE','Skxne lxn',98948);
insert into city values (3060,'Borxs','SWE','West Gxtanmaan lxn',96883);
insert into city values (3061,'Sundsvall','SWE','Vxsternorrlands lxn',93126);
insert into city values (3062,'Gxvle','SWE','Gxvleborgs lxn',90742);
...
insert into city values (3070,'Munich [Mxnchen]','DEU','Baijeri',1194560);
insert into city values (3071,'Kxln','DEU','Nordrhein-Westfalen',962507);
...
insert into city values (3075,'Stuttgart','DEU','Baden-Wxrttemberg',582443);
insert into city values (3076,'Dxsseldorf','DEU','Nordrhein-Westfalen',568855);
...
insert into city values (3081,'Nxrnberg','DEU','Baijeri',486628);
...
insert into city values (3086,'Mannheim','DEU','Baden-Wxrttemberg',307730);
...
insert into city values (3089,'Karlsruhe','DEU','Baden-Wxrttemberg',277204);
insert into city values (3090,'Wiesbaden','DEU','Hessen',268716);
insert into city values (3091,'Mxnster','DEU','Nordrhein-Westfalen',264670);
insert into city values (3092,'Mxnchengladbach','DEU','Nordrhein-Westfalen',263697);
...
insert into city values (3102,'Lxbeck','DEU','Schleswig-Holstein',213326);
...
insert into city values (3105,'Freiburg im Breisgau','DEU','Baden-Wxrttemberg',202455);
insert into city values (3106,'Erfurt','DEU','Thxringen',201267);
insert into city values (3107,'Kassel','DEU','Hessen',196211);
insert into city values (3108,'Saarbrxcken','DEU','Saarland',183836);
...
insert into city values (3112,'Mxlheim an der Ruhr','DEU','Nordrhein-Westfalen',173895);
insert into city values (3113,'Solingen','DEU','Nordrhein-Westfalen',165583);
insert into city values (3114,'Osnabrxck','DEU','Niedersachsen',164539);
...
insert into city values (3119,'Heidelberg','DEU','Baden-Wxrttemberg',139672);
...
insert into city values (3123,'Wxrzburg','DEU','Baijeri',127350);
...
insert into city values (3126,'Gxttingen','DEU','Niedersachsen',124775);
...
insert into city values (3131,'Heilbronn','DEU','Baden-Wxrttemberg',119526);
insert into city values (3132,'Pforzheim','DEU','Baden-Wxrttemberg',117227);
insert into city values (3133,'Offenbach am Main','DEU','Hessen',116627);
insert into city values (3134,'Ulm','DEU','Baden-Wxrttemberg',116103);
insert into city values (3135,'Ingolstadt','DEU','Baijeri',114826);
insert into city values (3136,'Gera','DEU','Thxringen',114718);
...
insert into city values (3139,'Reutlingen','DEU','Baden-Wxrttemberg',110343);
insert into city values (3140,'Fxrth','DEU','Baijeri',109771);
...
insert into city values (3152,'Jena','DEU','Thxringen',99779);
insert into city values (3153,'Iserlohn','DEU','Nordrhein-Westfalen',99474);
insert into city values (3154,'Gxtersloh','DEU','Nordrhein-Westfalen',95028);
insert into city values (3155,'Marl','DEU','Nordrhein-Westfalen',93735);
insert into city values (3156,'Lxnen','DEU','Nordrhein-Westfalen',92044);
insert into city values (3157,'Dxren','DEU','Nordrhein-Westfalen',91092);
...
insert into city values (3160,'Esslingen am Neckar','DEU','Baden-Wxrttemberg',89667);
...
insert into city values (3172,'Sxo Tomx','STP','Aqua Grande',49541);
...
insert into city values (3192,'Araxar','SAU','al-Khudud al-Samaliy',108100);
...
insert into city values (3199,'Thixs','SEN','Thixs',248000);
...
insert into city values (3204,'Mbour','SEN','Thixs',109300);
insert into city values (3205,'Diourbel','SEN','Diourbel',99400);
insert into city values (3206,'Victoria','SYC','Mahx',41000);
insert into city values (3207,'Freetown','SLE','Western',850000);
insert into city values (3208,'Singapore','SGP','x',4017733);
insert into city values (3209,'Bratislava','SVK','Bratislava',448292);
insert into city values (3210,'Koxice','SVK','Vxchodnx Slovensko',241874);
insert into city values (3211,'Prexov','SVK','Vxchodnx Slovensko',93977);
...
insert into city values (3285,'Taiping','TWN','x',165524);
...
insert into city values (3293,'Taliao','TWN','x',115897);
insert into city values (3294,'Kueishan','TWN','x',112195);
...
insert into city values (3300,'Touliu','TWN','Yxnlin',98900);
...
insert into city values (3315,'Kxbenhavn','DNK','Kxbenhavn',495699);
insert into city values (3316,'xrhus','DNK','xrhus',284846);
...
insert into city values (3332,'Lomx','TGO','Maritime',375000);
insert into city values (3333,'Fakaofo','TKL','Fakaofo',300);
insert into city values (3334,'Nukuxalofa','TON','Tongatapu',22400);
...
insert into city values (3337,'NxDjamxna','TCD','Chari-Baguirmi',530965);
insert into city values (3338,'Moundou','TCD','Logone Occidental',99500);
insert into city values (3339,'Praha','CZE','Hlavnx mesto Praha',1181126);
insert into city values (3340,'Brno','CZE','Jiznx Morava',381862);
insert into city values (3341,'Ostrava','CZE','Severnx Morava',320041);
insert into city values (3342,'Plzen','CZE','Zapadnx Cechy',166759);
insert into city values (3343,'Olomouc','CZE','Severnx Morava',102702);
insert into city values (3344,'Liberec','CZE','Severnx Cechy',99155);
insert into city values (3345,'Ceskx Budejovice','CZE','Jiznx Cechy',98186);
insert into city values (3346,'Hradec Krxlovx','CZE','Vxchodnx Cechy',98080);
insert into city values (3347,'xstx nad Labem','CZE','Severnx Cechy',95491);
insert into city values (3348,'Pardubice','CZE','Vxchodnx Cechy',91309);
...
insert into city values (3356,'Gabxs','TUN','Gabxs',106600);
...
insert into city values (3364,'Mersin (Ixel)','TUR','Ixel',587212);
...
insert into city values (3378,'Elxzig','TUR','Elxzig',228815);
...
insert into city values (3388,'xorum','TUR','xorum',145495);
insert into city values (3389,'Kxtahya','TUR','Kxtahya',144761);
...
insert into city values (3398,'xorlu','TUR','Tekirdag',123300);
insert into city values (3399,'Isparta','TUR','Isparta',121911);
insert into city values (3400,'Karabxk','TUR','Karabxk',118285);
...
insert into city values (3443,'Txernigiv','UKR','Txernigiv',313000);
insert into city values (3444,'Txerkasy','UKR','Txerkasy',309000);
...
insert into city values (3451,'Txernivtsi','UKR','Txernivtsi',259000);
insert into city values (3452,'Rivne','UKR','Rivne',245000);
insert into city values (3453,'Krementxuk','UKR','Pultava',239000);
...
insert into city values (3460,'Kertx','UKR','Krim',162000);
...
insert into city values (3467,'Altxevsk','UKR','Lugansk',119000);
insert into city values (3468,'Lysytxansk','UKR','Lugansk',116000);
...
insert into city values (3472,'Krasnyi Lutx','UKR','Lugansk',101000);
...
insert into city values (3477,'Berdytxiv','UKR','Zytomyr',90000);
insert into city values (3478,'Izmajil','UKR','Odesa',90000);
insert into city values (3479,'xostka','UKR','Sumy',90000);
insert into city values (3480,'Uman','UKR','Txerkasy',90000);
insert into city values (3481,'Brovary','UKR','Kiova',89000);
insert into city values (3482,'Mukatxeve','UKR','Taka-Karpatia',89000);
insert into city values (3483,'Budapest','HUN','Budapest',1811552);
insert into city values (3484,'Debrecen','HUN','Hajdx-Bihar',203648);
insert into city values (3485,'Miskolc','HUN','Borsod-Abaxj-Zemplxn',172357);
insert into city values (3486,'Szeged','HUN','Csongrxd',158158);
insert into city values (3487,'Pxcs','HUN','Baranya',157332);
insert into city values (3488,'Gyxr','HUN','Gyxr-Moson-Sopron',127119);
insert into city values (3489,'Nyiregyhxza','HUN','Szabolcs-Szatmxr-Ber',112419);
insert into city values (3490,'Kecskemxt','HUN','Bxcs-Kiskun',105606);
insert into city values (3491,'Szxkesfehxrvxr','HUN','Fejxr',105119);
insert into city values (3492,'Montevideo','URY','Montevideo',1236000);
insert into city values (3493,'Noumxa','NCL','x',76293);
...
insert into city values (3510,'Kxkon','UZB','Fargona',190100);
...
insert into city values (3514,'xrgenc','UZB','Khorazm',138900);
...
insert into city values (3527,'Baranovitxi','BLR','Brest',167000);
insert into city values (3528,'Borisov','BLR','Minsk',151000);
insert into city values (3529,'Pinsk','BLR','Brest',130000);
insert into city values (3530,'Orxa','BLR','Vitebsk',124000);
...
insert into city values (3535,'Molodetxno','BLR','Minsk',97000);
insert into city values (3536,'Mata-Utu','WLF','Wallis',1137);
insert into city values (3537,'Port-Vila','VUT','Shefa',33700);
insert into city values (3538,'Cittx del Vaticano','VAT','x',455);
insert into city values (3539,'Caracas','VEN','Distrito Federal',1975294);
insert into city values (3540,'Maracaxbo','VEN','Zulia',1304776);
insert into city values (3541,'Barquisimeto','VEN','Lara',877239);
insert into city values (3542,'Valencia','VEN','Carabobo',794246);
insert into city values (3543,'Ciudad Guayana','VEN','Bolxvar',663713);
insert into city values (3544,'Petare','VEN','Miranda',488868);
insert into city values (3545,'Maracay','VEN','Aragua',444443);
insert into city values (3546,'Barcelona','VEN','Anzoxtegui',322267);
insert into city values (3547,'Maturxn','VEN','Monagas',319726);
insert into city values (3548,'San Cristxbal','VEN','Txchira',319373);
insert into city values (3549,'Ciudad Bolxvar','VEN','Bolxvar',301107);
insert into city values (3550,'Cumanx','VEN','Sucre',293105);
insert into city values (3551,'Mxrida','VEN','Mxrida',224887);
...
insert into city values (3557,'Santa Ana de Coro','VEN','Falcxn',185766);
insert into city values (3558,'Los Teques','VEN','Miranda',178784);
insert into city values (3559,'Punto Fijo','VEN','Falcxn',167215);
insert into city values (3560,'Guarenas','VEN','Miranda',165889);
insert into city values (3561,'Acarigua','VEN','Portuguesa',158954);
insert into city values (3562,'Puerto La Cruz','VEN','Anzoxtegui',155700);
insert into city values (3563,'Ciudad Losada','VEN','x',134501);
...
insert into city values (3567,'Carxpano','VEN','Sucre',119639);
insert into city values (3568,'Catia La Mar','VEN','Distrito Federal',117012);
insert into city values (3569,'El Tigre','VEN','Anzoxtegui',116256);
insert into city values (3570,'Guatire','VEN','Miranda',109121);
insert into city values (3571,'Calabozo','VEN','Guxrico',107146);
insert into city values (3572,'Pozuelos','VEN','Anzoxtegui',105690);
insert into city values (3573,'Ciudad Ojeda','VEN','Zulia',99354);
insert into city values (3574,'Ocumare del Tuy','VEN','Miranda',97168);
insert into city values (3575,'Valle de la Pascua','VEN','Guxrico',95927);
...
insert into city values (3579,'El Limxn','VEN','Aragua',90000);
...
insert into city values (3588,'Ufa','RUS','Baxkortostan',1091200);
insert into city values (3589,'Txeljabinsk','RUS','Txeljabinsk',1083200);
...
insert into city values (3610,'Nabereznyje Txelny','RUS','Tatarstan',514700);
...
insert into city values (3618,'Txeboksary','RUS','Txuvassia',459200);
...
insert into city values (3622,'Magnitogorsk','RUS','Txeljabinsk',427900);
...
insert into city values (3629,'Sotxi','RUS','Krasnodar',358600);
...
insert into city values (3636,'Mahatxkala','RUS','Dagestan',332800);
insert into city values (3637,'Txerepovets','RUS','Vologda',324400);
...
insert into city values (3641,'Txita','RUS','Txita',309900);
...
insert into city values (3653,'Sterlitamak','RUS','Baxkortostan',265200);
insert into city values (3654,'Angarsk','RUS','Irkutsk',264700);
insert into city values (3655,'Joxkar-Ola','RUS','Marinmaa',249200);
...
insert into city values (3659,'Naltxik','RUS','Kabardi-Balkaria',233400);
...
insert into city values (3664,'Blagovextxensk','RUS','Amur',222000);
insert into city values (3665,'xahty','RUS','Rostov-na-Donu',221800);
...
insert into city values (3671,'Zlatoust','RUS','Txeljabinsk',196900);
insert into city values (3672,'Jakutsk','RUS','Saha (Jakutia)',195400);
insert into city values (3673,'Podolsk','RUS','Moskova',194300);
insert into city values (3674,'Petropavlovsk-Kamtxatski','RUS','Kamtxatka',194100);
...
insert into city values (3678,'Grozny','RUS','Txetxenia',186000);
insert into city values (3679,'Novotxerkassk','RUS','Rostov-na-Donu',184400);
...
insert into city values (3685,'Miass','RUS','Txeljabinsk',166200);
...
insert into city values (3692,'Salavat','RUS','Baxkortostan',156800);
insert into city values (3693,'Mytixtxi','RUS','Moskova',155700);
...
insert into city values (3704,'Balaxiha','RUS','Moskova',132900);
...
insert into city values (3711,'Kamyxin','RUS','Volgograd',124600);
insert into city values (3712,'Novotxeboksarsk','RUS','Txuvassia',123400);
insert into city values (3713,'Txerkessk','RUS','Karatxai-Txerkessia',121700);
insert into city values (3714,'Atxinsk','RUS','Krasnojarsk',121600);
insert into city values (3715,'Magadan','RUS','Magadan',121000);
insert into city values (3716,'Mitxurinsk','RUS','Tambov',120700);
...
insert into city values (3722,'Novokuibyxevsk','RUS','Samara',116200);
insert into city values (3723,'Neftekamsk','RUS','Baxkortostan',115700);
insert into city values (3724,'Leninsk-Kuznetski','RUS','Kemerovo',113800);
insert into city values (3725,'Oktjabrski','RUS','Baxkortostan',111500);
...
insert into city values (3736,'xtxolkovo','RUS','Moskova',104900);
insert into city values (3737,'Mezduretxensk','RUS','Kemerovo',104400);
insert into city values (3738,'Usolje-Sibirskoje','RUS','Irkutsk',103500);
insert into city values (3739,'Elista','RUS','Kalmykia',103300);
insert into city values (3740,'Novoxahtinsk','RUS','Rostov-na-Donu',101900);
...
insert into city values (3746,'Kinexma','RUS','Ivanovo',100000);
...
insert into city values (3754,'Balaxov','RUS','Saratov',97100);
...
insert into city values (3773,'Bixn Hoa','VNM','Dong Nai',282095);
...
insert into city values (3785,'Phan Thixt','VNM','Binh Thuan',114236);
...
insert into country values ('AGO','Angola','Africa','Central Africa',1246700.00,1975,12878000,38.3,6648.00,7984.00,'Angola','Republic','Josx Eduardo dos Santos',56,'AO');
...
insert into country values ('ALB','Albania','Europe','Southern Europe',28748.00,1912,3401200,71.6,3205.00,2500.00,'Shqipxria','Republic','Rexhep Mejdani',34,'AL');
...
insert into country values ('ARE','United Arab Emirates','Asia','Middle East',83600.00,1971,2441000,74.1,37966.00,36846.00,'Al-Imarat al-xArabiya al-Muttahida','Emirate Federation','Zayid bin Sultan al-Nahayan',65,'AE');
insert into country values ('ARG','Argentina','South America','South America',2780400.00,1816,37032000,75.1,340238.00,323310.00,'Argentina','Federal Republic','Fernando de la Rxa',69,'AR');
insert into country values ('ARM','Armenia','Asia','Middle East',29800.00,1991,3520000,66.4,1813.00,1627.00,'Hajastan','Republic','Robert Kotxarjan',126,'AM');
...
insert into country values ('ATA','Antarctica','Antarctica','Antarctica',13120000.00,NULL,0,NULL,0.00,NULL,'x','Co-administrated','',NULL,'AQ');
insert into country values ('ATF','French Southern territories','Antarctica','Antarctica',7780.00,NULL,0,NULL,0.00,NULL,'Terres australes franxaises','Nonmetropolitan Territory of France','Jacques Chirac',NULL,'TF');
...
insert into country values ('AUT','Austria','Europe','Western Europe',83859.00,1918,8091800,77.7,211860.00,206025.00,'xsterreich','Federal Republic','Thomas Klestil',1523,'AT');
insert into country values ('AZE','Azerbaijan','Asia','Middle East',86600.00,1991,7734000,62.9,4127.00,4100.00,'Azxrbaycan','Federal Republic','Heydxr xliyev',144,'AZ');
...
insert into country values ('BEL','Belgium','Europe','Western Europe',30518.00,1830,10239000,77.8,249704.00,243948.00,'Belgix/Belgique','Constitutional Monarchy, Federation','Albert II',179,'BE');
insert into country values ('BEN','Benin','Africa','Western Africa',112622.00,1960,6097000,50.2,2357.00,2141.00,'Bxnin','Republic','Mathieu Kxrxkou',187,'BJ');
insert into country values ('BFA','Burkina Faso','Africa','Western Africa',274000.00,1960,11937000,46.7,2425.00,2201.00,'Burkina Faso','Republic','Blaise Compaorx',549,'BF');
...
insert into country values ('BLR','Belarus','Europe','Eastern Europe',207600.00,1991,10236000,68.0,13714.00,NULL,'Belarus','Republic','Aljaksandr Lukaxenka',3520,'BY');
...
insert into country values ('BOL','Bolivia','South America','South America',1098581.00,1825,8329000,63.7,8571.00,7967.00,'Bolivia','Republic','Hugo Bxnzer Suxrez',194,'BO');
...
insert into country values ('BVT','Bouvet Island','Antarctica','Antarctica',59.00,NULL,0,NULL,0.00,NULL,'Bouvetxya','Dependent Territory of Norway','Harald V',NULL,'BV');
...
insert into country values ('CAF','Central African Republic','Africa','Central Africa',622984.00,1960,3615000,44.0,1054.00,993.00,'Centrafrique/Bx-Afrxka','Republic','Ange-Fxlix Patassx',1889,'CF');
...
insert into country values ('CIV','Cxte dxIvoire','Africa','Western Africa',322463.00,1960,14786000,45.2,11345.00,10285.00,'Cxte dxIvoire','Republic','Laurent Gbagbo',2814,'CI');
...
insert into country values ('COD','Congo, The Democratic Republic of the','Africa','Central Africa',2344858.00,1960,51654000,48.8,6964.00,2474.00,'Rxpublique Dxmocratique du Congo','Republic','Joseph Kabila',2298,'CD');
...
insert into country values ('COL','Colombia','South America','South America',1138914.00,1810,42321000,70.3,102896.00,105116.00,'Colombia','Republic','Andrxs Pastrana Arango',2257,'CO');
...
insert into country values ('CPV','Cape Verde','Africa','Western Africa',4033.00,1975,428000,68.9,435.00,420.00,'Cabo Verde','Republic','Antxnio Mascarenhas Monteiro',1859,'CV');
insert into country values ('CRI','Costa Rica','North America','Central America',51100.00,1821,4023000,75.8,10226.00,9757.00,'Costa Rica','Republic','Miguel xngel Rodrxguez Echeverrxa',584,'CR');
...
insert into country values ('CYP','Cyprus','Asia','Middle East',9251.00,1960,754700,76.7,9333.00,8246.00,'Kxpros/Kibris','Republic','Glafkos Klerides',2430,'CY');
insert into country values ('CZE','Czech Republic','Europe','Eastern Europe',78866.00,1993,10278100,74.5,55017.00,52037.00,'xesko','Republic','Vxclav Havel',3339,'CZ');
...
insert into country values ('DOM','Dominican Republic','North America','Caribbean',48511.00,1844,8495000,73.2,15846.00,15076.00,'Repxblica Dominicana','Republic','Hipxlito Mejxa Domxnguez',587,'DO');
insert into country values ('DZA','Algeria','Africa','Northern Africa',2381741.00,1962,31471000,69.7,49982.00,46966.00,'Al-Jazaxir/Algxrie','Republic','Abdelaziz Bouteflika',35,'DZ');
...
insert into country values ('ESP','Spain','Europe','Southern Europe',505992.00,1492,39441700,78.8,553233.00,532031.00,'Espaxa','Constitutional Monarchy','Juan Carlos I',653,'ES');
...
insert into country values ('ETH','Ethiopia','Africa','Eastern Africa',1104300.00,-1000,62565000,45.2,6353.00,6180.00,'YeItyopxiya','Republic','Negasso Gidada',756,'ET');
...
insert into country values ('FRO','Faroe Islands','Europe','Nordic Countries',1399.00,NULL,43000,78.4,0.00,NULL,'Fxroyar','Part of Denmark','Margrethe II',901,'FO');
...
insert into country values ('GEO','Georgia','Asia','Middle East',69700.00,1991,4968000,64.5,6064.00,5924.00,'Sakartvelo','Republic','Eduard xevardnadze',905,'GE');
...
insert into country values ('GIN','Guinea','Africa','Western Africa',245857.00,1958,7430000,45.6,2352.00,2383.00,'Guinxe','Republic','Lansana Contx',926,'GN');
...
insert into country values ('GNB','Guinea-Bissau','Africa','Western Africa',36125.00,1974,1213000,49.0,293.00,272.00,'Guinx-Bissau','Republic','Kumba Ialx',927,'GW');
...
insert into country values ('GRC','Greece','Europe','Southern Europe',131626.00,1830,10545700,78.4,120724.00,119946.00,'Ellxda','Republic','Kostis Stefanopoulos',2401,'GR');
...
insert into country values ('GRL','Greenland','North America','North America',2166090.00,NULL,56000,68.1,0.00,NULL,'Kalaallit Nunaat/Grxnland','Part of Denmark','Margrethe II',917,'GL');
...
insert into country values ('GUF','French Guiana','South America','South America',90000.00,NULL,181000,76.1,681.00,NULL,'Guyane franxaise','Overseas Department of France','Jacques Chirac',3014,'GF');
...
insert into country values ('HND','Honduras','North America','Central America',112088.00,1838,6485000,69.9,5333.00,4697.00,'Honduras','Republic','Carlos Roberto Flores Facussx',933,'HN');
insert into country values ('HRV','Croatia','Europe','Southern Europe',56538.00,1991,4473000,73.7,20208.00,19300.00,'Hrvatska','Republic','xtipe Mesic',2409,'HR');
insert into country values ('HTI','Haiti','North America','Caribbean',27750.00,1804,8222000,49.2,3459.00,3107.00,'Haxti/Dayti','Republic','Jean-Bertrand Aristide',929,'HT');
insert into country values ('HUN','Hungary','Europe','Eastern Europe',93030.00,1918,10043200,71.4,48267.00,45914.00,'Magyarorszxg','Republic','Ferenc Mxdl',3483,'HU');
...
insert into country values ('IRL','Ireland','Europe','British Islands',70273.00,1921,3775100,76.8,75921.00,73132.00,'Ireland/xire','Republic','Mary McAleese',1447,'IE');
...
insert into country values ('IRQ','Iraq','Asia','Middle East',438317.00,1932,23115000,66.5,11500.00,NULL,'Al-xIraq','Republic','Saddam Hussein al-Takriti',1365,'IQ');
insert into country values ('ISL','Iceland','Europe','Nordic Countries',103000.00,1944,279000,79.4,8255.00,7474.00,'xsland','Republic','xlafur Ragnar Grxmsson',1449,'IS');
insert into country values ('ISR','Israel','Asia','Middle East',21056.00,1948,6217000,78.6,97477.00,98577.00,'Yisraxel/Israxil','Republic','Moshe Katzav',1450,'IL');
...
insert into country values ('KHM','Cambodia','Asia','Southeast Asia',181035.00,1953,11168000,56.5,5121.00,5670.00,'Kxmpuchxa','Constitutional Monarchy','Norodom Sihanouk',1800,'KH');
...
insert into country values ('KOR','South Korea','Asia','Eastern Asia',99434.00,1948,46844000,74.4,320749.00,442544.00,'Taehan Minxguk (Namhan)','Republic','Kim Dae-jung',2331,'KR');
...
insert into country values ('LBN','Lebanon','Asia','Middle East',10400.00,1941,3282000,71.3,17121.00,15129.00,'Lubnan','Republic','xmile Lahoud',2438,'LB');
...
insert into country values ('LUX','Luxembourg','Europe','Western Europe',2586.00,1867,435700,77.1,16321.00,15519.00,'Luxembourg/Lxtzebuerg','Constitutional Monarchy','Henri',2452,'LU');
...
insert into country values ('MEX','Mexico','North America','Central America',1958201.00,1810,98881000,71.5,414972.00,401461.00,'Mxxico','Federal Republic','Vicente Fox Quesada',2515,'MX');
...
insert into country values ('MLI','Mali','Africa','Western Africa',1240192.00,1960,11234000,46.7,2642.00,2453.00,'Mali','Republic','Alpha Oumar Konarx',2482,'ML');
...
insert into country values ('MOZ','Mozambique','Africa','Eastern Africa',801590.00,1975,19680000,37.5,2891.00,2711.00,'Moxambique','Republic','Joaquxm A. Chissano',2698,'MZ');
insert into country values ('MRT','Mauritania','Africa','Western Africa',1025520.00,1960,2670000,50.8,998.00,1081.00,'Muritaniya/Mauritanie','Republic','Maaouiya Ould SidxAhmad Taya',2509,'MR');
...
insert into country values ('NCL','New Caledonia','Oceania','Melanesia',18575.00,NULL,214000,72.8,3563.00,NULL,'Nouvelle-Calxdonie','Nonmetropolitan Territory of France','Jacques Chirac',3493,'NC');
...
insert into country values ('NIC','Nicaragua','North America','Central America',130000.00,1838,5074000,68.7,1988.00,2023.00,'Nicaragua','Republic','Arnoldo Alemxn Lacayo',2734,'NI');
...
insert into country values ('OMN','Oman','Asia','Middle East',309500.00,1951,2542000,71.8,16904.00,16153.00,'xUman','Monarchy (Sultanate)','Qabus ibn Saxid',2821,'OM');
...
insert into country values ('PAN','Panama','North America','Central America',75517.00,1903,2856000,75.5,9131.00,8700.00,'Panamx','Republic','Mireya Elisa Moscoso Rodrxguez',2882,'PA');
...
insert into country values ('PER','Peru','South America','South America',1285216.00,1821,25662000,70.0,64140.00,65186.00,'Perx/Piruw','Republic','Valentin Paniagua Corazao',2890,'PE');
...
insert into country values ('PRK','North Korea','Asia','Eastern Asia',120538.00,1948,24039000,70.7,5332.00,NULL,'Choson Minjujuui Inxmin Konghwaguk (Bukhan)','Socialistic Republic','Kim Jong-il',2318,'KP');
insert into country values ('PRT','Portugal','Europe','Southern Europe',91982.00,1143,9997600,75.8,105954.00,102133.00,'Portugal','Republic','Jorge Sampxio',2914,'PT');
insert into country values ('PRY','Paraguay','South America','South America',406752.00,1811,5496000,73.7,8444.00,9555.00,'Paraguay','Republic','Luis xngel Gonzxlez Macchi',2885,'PY');
...
insert into country values ('PYF','French Polynesia','Oceania','Polynesia',4000.00,NULL,235000,74.8,818.00,781.00,'Polynxsie franxaise','Nonmetropolitan Territory of France','Jacques Chirac',3016,'PF');
...
insert into country values ('REU','Rxunion','Africa','Eastern Africa',2510.00,NULL,699000,72.7,8287.00,7988.00,'Rxunion','Overseas Department of France','Jacques Chirac',3017,'RE');
insert into country values ('ROM','Romania','Europe','Eastern Europe',238391.00,1878,22455500,69.9,38158.00,34843.00,'Romxnia','Republic','Ion Iliescu',3018,'RO');
...
insert into country values ('SAU','Saudi Arabia','Asia','Middle East',2149690.00,1932,21607000,67.8,137635.00,146171.00,'Al-xArabiya as-Saxudiya','Monarchy','Fahd ibn Abdul-Aziz al-Saxud',3173,'SA');
...
insert into country values ('SEN','Senegal','Africa','Western Africa',196722.00,1960,9481000,62.2,4787.00,4542.00,'Sxnxgal/Sounougal','Republic','Abdoulaye Wade',3198,'SN');
...
insert into country values ('SLV','El Salvador','North America','Central America',21041.00,1841,6276000,69.7,11863.00,11203.00,'El Salvador','Republic','Francisco Guillermo Flores Pxrez',645,'SV');
...
insert into country values ('STP','Sao Tome and Principe','Africa','Central Africa',964.00,1975,147000,65.3,6.00,NULL,'Sxo Tomx e Prxncipe','Republic','Miguel Trovoada',3172,'ST');
...
insert into country values ('SYC','Seychelles','Africa','Eastern Africa',455.00,1976,77000,70.4,536.00,539.00,'Sesel/Seychelles','Republic','France-Albert Renx',3206,'SC');
...
insert into country values ('TCD','Chad','Africa','Central Africa',1284000.00,1960,7651000,50.5,1208.00,1102.00,'Tchad/Tshad','Republic','Idriss Dxby',3337,'TD');
insert into country values ('TGO','Togo','Africa','Western Africa',56785.00,1960,4629000,54.7,1449.00,1400.00,'Togo','Republic','Gnassingbx Eyadxma',3332,'TG');
...
insert into country values ('TJK','Tajikistan','Asia','Southern and Central Asia',143100.00,1991,6188000,64.1,1990.00,1056.00,'Toxikiston','Republic','Emomali Rahmonov',3261,'TJ');
...
insert into country values ('TKM','Turkmenistan','Asia','Southern and Central Asia',488100.00,1991,4459000,60.9,4397.00,2000.00,'Txrkmenostan','Republic','Saparmurad Nijazov',3419,'TM');
insert into country values ('TMP','East Timor','Asia','Southeast Asia',14874.00,NULL,885000,46.0,0.00,NULL,'Timor Timur','Administrated by the UN','Josx Alexandre Gusmxo',1522,'TP');
...
insert into country values ('TUR','Turkey','Asia','Middle East',774815.00,1923,66591000,71.0,210721.00,189122.00,'Txrkiye','Republic','Ahmet Necdet Sezer',3358,'TR');
...
insert into country values ('TWN','Taiwan','Asia','Eastern Asia',36188.00,1945,22256000,76.4,256254.00,263451.00,'Txai-wan','Republic','Chen Shui-bian',3263,'TW');
...
insert into country values ('UKR','Ukraine','Europe','Eastern Europe',603700.00,1991,50456000,66.0,42168.00,49677.00,'Ukrajina','Republic','Leonid Kutxma',3426,'UA');
...
insert into country values ('URY','Uruguay','South America','South America',175016.00,1828,3337000,75.2,20831.00,19967.00,'Uruguay','Republic','Jorge Batlle Ibxxez',3492,'UY');
...
insert into country values ('VAT','Holy See (Vatican City State)','Europe','Southern Europe',0.40,1929,1000,NULL,9.00,NULL,'Santa Sede/Cittx del Vaticano','Independent Church State','Johannes Paavali II',3538,'VA');
...
insert into country values ('VEN','Venezuela','South America','South America',912050.00,1811,24170000,73.1,95023.00,88434.00,'Venezuela','Federal Republic','Hugo Chxvez Frxas',3539,'VE');
...
insert into country values ('VNM','Vietnam','Asia','Southeast Asia',331689.00,1945,79832000,69.3,21929.00,22834.00,'Vixt Nam','Socialistic Republic','Trxn Duc Luong',3770,'VN');
...
insert into country values ('YUG','Yugoslavia','Europe','Southern Europe',102173.00,1918,10640000,72.4,17000.00,NULL,'Jugoslavija','Federal Republic','Vojislav Koxtunica',1792,'YU');
